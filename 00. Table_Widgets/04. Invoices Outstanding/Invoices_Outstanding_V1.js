(function () {
  class InvoicesOutstandingTableWidget extends HTMLElement {
    constructor() {
      super();
      ...
      /* =========================
        TITLE STYLE
      ========================= */
      this._titleText = "INVOICES OUTSTANDING";
  ...
  customElements.define("com-max-table-outstanding", InvoicesOutstandingTableWidget);
})();
