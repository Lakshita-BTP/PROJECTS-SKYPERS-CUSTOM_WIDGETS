(function () {
  class SalesWithTaxTableWidget extends HTMLElement {
    constructor() {
      super();
      ...
      /* =========================
        TITLE STYLE
      ========================= */
      this._titleText = "OVERDUE ANALYSIS  -  TOTAL DUE";
  ...
  customElements.define("com-max-table-saleswithtax", SalesWithTaxTableWidget);
})();
