(function () {
  class SalesTableWidget extends HTMLElement {
    ...
    render() {
      ...
      console.log("Binding State:", this._myDataBinding.state);
      console.log("Dimensions:", this._myDataBinding.metadata.feeds.dimensions.values);
      console.log("Measures:", this._myDataBinding.metadata.feeds.measures.values);
      console.log("Rows:", this._myDataBinding.data);
