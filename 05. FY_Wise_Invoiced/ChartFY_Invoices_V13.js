(function () {
  ...
  class FYComparisonWidget extends HTMLElement {
    ...
    fireBarClick(fy, measure, value) {
      this._selectedFY = fy;
      this._selectedMeasure = measure;
      this._selectedValue = value;

      this.dispatchEvent(
        new CustomEvent("onBarClick", {
          detail: {
            fy: fy,
            measure: measure,
            value: value,
      ...
      try {
        ...
        data.forEach((item) => {
          ...
          <div class="group">
              ...
              <div class="value-row">
                  ...
                  <div class="inv-value">
                      ${item.invoiced.toLocaleString(undefined, {
              ...
              <div class="bars">
                  ...
                  <div
                      class="bar bar-inv"
                      data-fy="${item.fy}"
                      data-measure="Invoiced"
                      data-value="${item.invoiced}"
                  ...
                  <div
                      class="bar bar-col"
                      data-fy="${item.fy}"
                      data-measure="Collected"
                      data-value="${item.collected}"
        ...
        chart.querySelectorAll(".bar").forEach((bar) => {
          ...
          bar.addEventListener("click", () => {
            const fy = bar.dataset.fy;
            const measure = bar.dataset.measure;
            const value = Number(bar.dataset.value);

            this.fireBarClick(fy, measure, value);
          });
        });
      } catch (e) {
