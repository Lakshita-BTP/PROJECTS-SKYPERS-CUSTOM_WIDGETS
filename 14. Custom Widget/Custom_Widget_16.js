(function () {
  class CustomWidget extends HTMLElement {
    ...
    async serializeCustomWidgetToImage() {
      ...
      const bodyTop = headerH + height * 0.01;
      ...
      /*----------------------------------
          Avg Box
      -----------------------------------*/
      const avgY = startY + boxH * 2 + gap * 1.8;
      const avgH = height * 0.14;
      ...
      ctx.fillStyle = "#16263B";
      ctx.fillText(value, width / 2 - 18, avgY + avgH * 0.72);
