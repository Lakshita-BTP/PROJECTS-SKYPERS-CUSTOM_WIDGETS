  ...
  class PaymentForecastDashboard extends HTMLElement {
          ...
          html += `
            <div class="bucket" data-label="${bucket.label}" data-value="${bucket.value}">
              <div class="bucket-header">
                ...
                <div style="display:flex; align-items:center; justify-content:flex-end; gap:8px; min-width:170px; flex-shrink:0; ">
    ...
    async serializeCustomWidgetToImage() {
      ...
      this._forecastData.forEach((bucket, index) => {
        ...
        ctx.beginPath();
        ctx.roundRect(leftX, barY, leftWidth, barHeight, 5);
        ctx.fill();
        ...
        ctx.fillText(share.toFixed(1) + "%", leftX + leftWidth - 85, y);
      ...
      const chartWidth = rightWidth - 10;
